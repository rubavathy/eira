...
const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [RouteGuardService],  data: { pageTitle: 'Equipment Configuration - Site'} 
  },
  {
  ...
  },
  {
    ...
    canActivate: [RouteGuardService],  data: { pageTitle: 'Eira Ticket Search'} 
  },
...

  {
    path: '',
    loadChildren: () =>
      import('./user-site-mapping/user-site-mapping.module').then(
        (m) => m.UserSiteMappingModule
      ),
  },
